/**
 * A game that ask the player which number he is thinking about
 * 
 * @author Mårten Hernebring, Nahid Vafaie
 * @version 1.1
 * @since 1.0
 *        <p>
 *        Assignment 1 - Om Java-klassen Guesser 1. Kommunicerar med spelaren
 *        som ska tänka på ett tal och svara på spelets frågor 2. Försöker hitta
 *        vilket tal spelaren tänker på genom att ställa frågor om talet.
 *        </p>
 */
